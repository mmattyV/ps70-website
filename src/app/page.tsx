...
export default function Home() {
  const assignments = [
    ...
    { week: 14, title: 'Project Preparation', href: '/week14', completed: true },
    { week: 15, title: 'Final Project: Full Documentation', href: '/week15', completed: true },
  ];
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <Link
          href="/week15"
          className="glass-card-clickable rounded-2xl p-8 group bg-gradient-to-br from-red-500/20 to-orange-500/20"
        >
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-2xl font-bold text-white group-hover:text-orange-200 transition-colors">
              AI Sentry: Final Project
            </h3>
          </div>
          <p className="text-white/70 text-lg leading-relaxed">
            Autonomous person-tracking laser turret using YOLOv8 computer vision and ESP32S3.
          </p>
        </Link>
      </div>
    </div>
